...
return array(
	...
	'blogs_search_empty' => 'Поисковые пегасы вернулись ни с чем',
	...
	'topic_declension' => 'пост;поста;постов',
	...
	'blog_create_type_open_notice' => 'Открытый — к этому блогу может присоединиться любой желающий, посты видны всем',
	'blog_create_type_close_notice' => 'Закрытый — присоединиться можно только по приглашению администрации блога, посты видят только подписчики',
	...
	'blog_admin_delete_move' => 'Переместить посты в блог',
	...
	'blog_admin_user_add_label' => 'Добавить броняш',
	'blog_admin_user_invited' => 'Список приглашенных',
	'blog_admin_user_add_header' => 'Пригласить броняш',
	'blog_admin_user_add_empty' => 'Нет приглашенных броняш',
	...
	'topic_comment_add_text_error' => 'Текст комментария должен быть от 2 до 64000 символов и не содержать разного рода каку',
	 ...
	 * Создание топика
	 */
	'topic_topic_create' => 'Создание поста',
	'topic_topic_edit' => 'Редактирование поста',
	'topic_create' => 'Написать',
	'topic_create_blog' => 'В какой блог публикуем?',
	'topic_create_blog_personal' => 'мой персональный блог',
	'topic_create_blog_error_unknown' => 'Пытаетесь запостить пост в неизвестный блог?',
	...
	'topic_create_title_error' => 'Название поста должно быть от 2 до 200 символов',
	'topic_create_text' => 'Текст',
	'topic_create_text_notice' => 'Доступны html-теги',
	'topic_create_text_error' => 'Текст поста должен быть от 2 до 15000 символов',
	'topic_create_text_error_unique' => 'Вы уже писали пост с таким содержанием',
	'topic_create_type_error' => 'Неверный тип поста',
	'topic_create_tags' => 'Теги',
	'topic_create_tags_notice' => 'Теги нужно разделять запятой. Например: Луна, аликорны, новость',
	...
	'topic_create_publish_index_notice' => 'Если отметить эту галку, то пост сразу попадёт на главную страницу (опция доступна только администраторам)',
	...
	'topic_create_submit_notice' => 'Если нажать кнопку «Сохранить в черновиках», текст поста будет виден только Вам, а рядом с его заголовком будет отображаться замочек. Чтобы пост был виден всем, нажмите «Опубликовать».',
	...
	'topic_vote_error_already' => 'Вы уже голосовали за этот пост!',
	...
	'comment_save_edit' => 'Сохранить',
	'comment_preview_edit' => 'Предпросмотр',
	'comment_cancel_edit' => 'Отмена',
	...
	'comment_was_hidden' => 'комментарий скрыт',
	...
	'user_good' => 'На светлой стороне',
	'user_bad' => 'На темной стороне',
	...
	'user_not_activе' => 'Ваша учетная запись неактивна',
	'user_password' => 'Пароль',
	'user_password_reminder' => 'Напомнить пароль',
	'user_exit_notice' => 'Ты всё равно вернешься!',
	...
	'user_stats_noactive' => 'Впали в спячку',
	'user_stats_sex_man' => 'Жеребцы',
	'user_stats_sex_woman' => 'Кобылки',
	'user_stats_sex_other' => 'Жеребятушки',
	...
	'user_status_online' => 'На Табуне',
	'user_status_offline' => 'Спит',
	/**
	 * Меню профиля пользователя
	 */
	'people_menu_users' => 'Брони',
	...
	'settings_tuning_notice_new_topic' => 'при новом посте в блоге',
	'settings_tuning_notice_new_comment' => 'при новом комментарии в посте',
	...
	'block_blog_info_note_text' => '<strong>Тег &lt;cut&gt; сокращает длинные записи</strong>, скрывая их целиком или частично под ссылкой («читать дальше»). Скрытая часть не видна в блоге, но доступна в полной записи на странице поста.',
	'block_blogs' => 'Блоги',
	'block_blogs_top' => 'Топ',
	...
	'search' => 'Поиск',
	'search_submit' => 'Найти',
	'search_error' => 'Произошла неожиданная ошибка при поиске',
	...
	'talk_comment_add_text_error' => 'Текст комментария должен быть от 2 до 64000 символов',
	...
	'talk_create_text_error' => 'Текст сообщения должен быть от 2 до 64000 символов',
	...
	'stream_list_event_add_topic' => 'добавил новый пост',
	...
	'stream_list_event_add_topic_female' => 'добавила новый пост',
	...
	'notify_subject_topic_new' => 'Новый пост в блоге',
	...
	'admin_topics_recalculated' => 'Количество постов пересчитанно',
	/**
	 ...
	 */
	'comment_edit_deny_reason' => [
		'Вы не можете изменять этот комментарий',
		'Вы не можете изменять чужой комментарий',
		'Вы не можете изменять комментарий, на который есть ответы',
		'Вы не можете изменять чужой комментарий, на который есть ответы',
		'Срок редактирования комментария истёк',
		'Вы не можете изменять чужой комментарий, срок редактирования которого истёк',
		'Вы не можете изменять комментарий, на который есть ответы и срок редактирования которого истёк',
		'Вы не можете изменять чужой комментарий, на который есть ответы и срок редактирования которого истёк',
		'Возможность изменения этого комментария заблокирована администратором',
		'Вы не можете изменять чужой комментарий, возможность изменения которого заблокирована администратором',
		'Вы не можете изменять комментарий, на который есть ответы и возможность изменения которого заблокирована администратором',
		'Вы не можете изменять чужой комментарий, на который есть ответы и возможность изменения которого заблокирована администратором',
		'Срок редактирования комментария истёк и возможность его изменения заблокирована администратором',
		'Вы не можете изменять чужой комментарий, срок редактирования которого истёк и возможность изменения которого заблокирована администратором',
		'Вы не можете изменять комментарий, на который есть ответы, срок редактирования которого истёк и возможность изменения которого заблокирована администратором',
		'Вы не можете изменять чужой комментарий, на который есть ответы, срок редактирования которого истёк и возможность изменения которого заблокирована администратором',
	],
	'comment_edit_lock_denied' => 'Блокировка изменения этого комментария запрещена',
	'comment_not_changed' => 'Комментарий не изменён',
	'comment_changed' => 'Комментарий изменён',
	'comment_locked' => 'Комментарий заблокирован для изменения',
	'comment_changedAndLocked' => 'Комментарий изменён и заблокирован для изменения',
	'commentEditNotice_prefixChanged' => 'Изменён ',
	'commentEditNotice_prefixLocked' => 'Заблокирован ',
	'commentEditNotice_byAuthor' => 'автором',
	'commentEditNotice_byAdmin' => 'администратором',
	'commentEditNotice_suffixHard' => ' после ответа',
	'commentEditNotice_suffixLocked' => ' и заблокирован',
