...
{
const FLAG_HAS_ANSWER = 4;
const FLAG_MODIFIED = 8;
const FLAG_HARD_MODIFIED = 16;
const FLAG_LOCK_MODIFY = 32;
    ...
    {
        $this->_aData['flags'] = $this->_getDataOne('flags') & ~$mask;
    }    // комментарий изменён после того как на него ответили
    ...
    }    // изменение комментария заблокировано
